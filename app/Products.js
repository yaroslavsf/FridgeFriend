...
const initializeData = async () => {
    ...
    await AsyncStorage.setItem('productsFoodData', JSON.stringify(sampleData));
};
...
const Products = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let data = await AsyncStorage.getItem('productsFoodData');
                if (!data) {
                    await initializeData();
                    data = await AsyncStorage.getItem('productsFoodData');
                }
